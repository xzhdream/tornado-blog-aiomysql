...
define("db_host", default="192.168.179.215", help="blog database host")
define("db_port", default=3306, help="blog database port")
define("db_database", default="tornado_blog", help="blog database name")
define("db_user", default="arale", help="blog database user")
define("db_password", default="xxxxxx", help="blog database password")
...
class ComposeHandler(BaseHandler):
    ...
    async def post(self):
        ...
        if id:
            ...
            slug = slug.encode("utf-8", "ignore").decode("utf-8")
            if not slug:
                slug = "entry"
            while True:
...
class AuthCreateHandler(BaseHandler):
    ...
    async def post(self):
        ...
        author = await self.queryone("SELECT * FROM authors WHERE email = %s", self.get_argument("email"))
